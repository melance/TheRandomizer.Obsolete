...
namespace TheRandomizer.WebApp.Controllers
{
    public class ErrorController : Controller
    {
        ...
        private List<KeyValuePair<string, string>> _criticalFailures = new List<KeyValuePair<string, string>>()
        {
            ...
            new KeyValuePair<string, string>("I light my torch using burning hands.", "You light your torch and accidentally light yourself on fire as well.  You are immune to cold for the rest of your life."),
